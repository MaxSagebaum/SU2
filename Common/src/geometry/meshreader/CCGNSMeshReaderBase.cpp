...
CCGNSMeshReaderBase::~CCGNSMeshReaderBase() = default;

#ifdef HAVE_CGNS
void CCGNSMeshReaderBase::OpenCGNSFile(const string& val_filename) {
...
string CCGNSMeshReaderBase::GetCGNSElementType(ElementType_t val_elem_type, int& val_vtk_type) {
